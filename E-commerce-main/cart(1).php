...
if(isset($_POST['order_btn'])){
  ...
  if(mysqli_num_rows($cart_query) > 0){
     ...
     if($flag==1)
     {
       ...
       $detail_query = mysqli_query($conn, "INSERT INTO `orders`(userid, name, address, phone,  poskod, totalproduct, totalprice, status) VALUES('$userid','$name','$address','$number','$poskod','$total_product','$price_total','$status')") or die($conn -> error);
...
<div class="myDiv">
<?php echo "<h style='font-size: 24px;'>Total Amount= RM $total</h>"; ?>
</div>

<tbody>
    <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">

        <h5>If Cash On delivary Then Put 0 in Card Number Field</h5>
      ...
      <input type="hidden" name="user_name" value="<?php echo $_SESSION['username']; ?>">
       ...
       <div class="input-group form-group">
        <input type="number" class="form-control" placeholder="Card Number" name="mobnumber">
       </div>
