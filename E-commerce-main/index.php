  ...
  <div class="row">
    <div class="col-md-6">
        ...
        <div class="banner-text">
          ...
          <p class="bt2"><span class="bt3">Eco-Friendly</span>Marketplace</p>
          <p class="bt4">Eco-Friendly Marketplace an online shop for all sustainable and eco-friendly products. <br> We want to show people how to introduce sustainability into everyday lives, with everyday products; making sustainable simple swaps!</p>
  ...
  <div class="container">
    <div class="row">
      <div class="col-md-12 col-lg-6 col-sm-12">
        <span class="welcometitle">Welcome to Eco-Friendly Marketplace</span>
        ...
        <div class="row" id="wel1">
          ...
          <div class="col-md-10  col-lg-10 col-10">
            ...
            <p class="wp">HAVE A QUESTION? WE'RE HERE TO HELP<br>
			Email us at info@ecomarketplace.com and we'll get back to you. </p>
          </div>   
        </div>
      ...
      <div class="col-md-12 col-lg-6 col-sm-12">
        <img src="img/eco.jpg" class="img-fluid">
      </div>
    </div>
  </div>
</div>
